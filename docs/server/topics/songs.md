...
Song IDs are represented in *server-style*; for *client-style*, simply add one to the ID.

| Level ID | Song ID | Name                       | Artist         |
|----------|---------|----------------------------|----------------|
| `None`   | `-1`    | `Practice: Stay Inside Me` | `OcularNebula` |
| `1`      | `0`     | `Stereo Madness`           | `Foreverbound` |
| `2`      | `1`     | `Back on Track`            | `DJVI`         |
| `3`      | `2`     | `Polargeist`               | `Step`         |
| `4`      | `3`     | `Dry Out`                  | `DJVI`         |
| `5`      | `4`     | `Base after Base`          | `DJVI`         |
| `6`      | `5`     | `Can't Let Go`             | `DJVI`         |
